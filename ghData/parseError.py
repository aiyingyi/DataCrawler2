...
def gh_data_spider():
    ...
    detail_url = 'http://gk.vecc.org.cn/ergs/o3/infoOpen/preview?sbbh=' + 'eed447b627eeee8b58c4c9b8408096c5ce49eb8f8b9f6995' + '&isprotect=false'
    print(detail_url)
    ...
    # 每一页结束之后写入文件
    utils.saveData(result_list, 'F:/国环数据Test.xls')
