...
# 重型柴油车   http://gk.vecc.org.cn/ergs/o3/infoOpen/preview?sbbh=e90a899e2f7d6ebc62b14c077490fce9b21c5ae6f07f61d4&isprotect=false
...
# 环保信息  http://gk.vecc.org.cn/ergs/o3/infoOpen/preview?sbbh=216a53fa21daa2ac838d0c0c89b2ba9ed12db3aadc7c433f&isprotect=false
...
def parse_paeg_qxqyc(soup):
    ...
    res['KLBZQ_CGPF_XH_SCQY'] = trim_str(tds[7].text)
    res['KLBZQ_CGPF_TC_ZT_FZSCQY'] = tds[9].text
    res['TGXH_SCQY'] = tds[11].text
...
def parse_paeg_zxrqc(soup):
    ...
    res['ECUXH_SCQY'] = tds[23].text
    res['OBDXYGYS'] = tds[25].text
    res['YCGQXH_SCQY'] = tds[27].text
    res['PQHCLXTXS'] = tds[29].text
    res['CHZHQ_SY_XH_SCQY'] = trim_str(tds[31].text)
    res['CHZHQ_SY_FZ_ZT_TCSCQY'] = tds[33].text

    res['CHZHQ_SCR_XH_SCQY'] = trim_str(tds[35].text)
    res['CHZHQ_SCR_FZ_ZT_TCSCQY'] = tds[37].text

    res['CHZHQ_ASC_XH_SCQY'] = trim_str(tds[39].text)
    res['CHZHQ_ASC_FZ_ZT_TCSCQY'] = trim_str(tds[41].text)
    res['CHZHQ_LNT_XH_SCQY'] = tds[43].text
    res['CHZHQ_LNT_FZ_ZT_TCSCQY'] = trim_str(tds[45].text)
    res['PQXSQXH_SCQY'] = tds[47].text
...
def parse_paeg_qxcyc(soup):
    ...
    res['CLZZSMC'] = tds[11].text
    res['SCCDZ'] = tds[13].text
    res['CLMPWZ'] = tds[15].text
    res['OBDJKWZ'] = tds[17].text
    res['JZZL'] = tds[19].text
    ...
    res['DYHWZHQFZ_ZT_TCSCQY'] = tds[27].text
